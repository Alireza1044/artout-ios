    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if isFiltering {
            if isUserSearch {
                ...
                let viewController = storyboard?.instantiateViewController(identifier: "MyEventDetail") as? EventDetailViewController
...
extension MyEventsTableViewController: UISearchResultsUpdating {
...
extension MyEventsTableViewController: UISearchControllerDelegate {
    func didDismissSearchController(_ searchController: UISearchController) {
        self.tableView.reloadData()
        self.isUserSearch = false
    }
}
extension MyEventsTableViewController: UISearchBarDelegate {
